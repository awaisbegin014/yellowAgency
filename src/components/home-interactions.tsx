...
const serviceTabs = [
  ...
  { slug: "ai-ugc-services", title: "AI UGC", dashboard: "AI UGC Creator Studio", image: "social-media.jpg", description: "Hyper-realistic AI user-generated content videos and creator video ads built to engage and convert social audiences.", benefits: ["AI avatar and video ad creation", "Viral hooks & persuasive scriptwriting", "Multi-format creative variation & testing"] },
];
...
const serviceDashboardMetrics: Record<string, Array<{ label: string; value: string; change: string }>> = {
  ...
  "AI UGC": [{ label: "Videos Generated", value: "240+", change: "+65%" }, { label: "Avg. Hook Rate", value: "48.2%", change: "+14.6%" }, { label: "CTR Lift", value: "3.4x", change: "+1.1x" }],
};
