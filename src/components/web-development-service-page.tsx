      ...
      <section className="facebook-service__proof">
        <div className="container">
          ...
          <div className="facebook-service__videos">
            <article><Image src="/images/unsplash/partner-david.jpg" alt="Agency partner David Cho discussing Yellow's headless web development support" fill sizes="(max-width: 760px) 100vw, 50vw" /><div><h3>David Cho</h3><p>CTO &amp; Co-Founder, Vector Digital</p></div></article>
            <article><Image src="/images/unsplash/partner-elena.jpg" alt="Agency partner Elena Rostova sharing an enterprise web development success story" fill sizes="(max-width: 760px) 100vw, 50vw" /><div><h3>Elena Rostova</h3><p>Managing Director, Nexus Tech</p></div></article>
          </div>
        </div>
      </section>
