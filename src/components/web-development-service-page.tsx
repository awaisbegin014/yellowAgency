    ...
    <main id="top" className="inner-page facebook-service web-development-service">
      <section className="facebook-service__hero">
        <StaggerGroup className="container">
          <StaggerItem as="p" className="eyebrow">White-label web engineering</StaggerItem>
          <StaggerItem as="h1">White Label <span>Web Development</span></StaggerItem>
          <StaggerItem as="p">Technical planning, frontend and CMS builds, integrations, responsive implementation, QA, launch, and maintenance—delivered quietly behind your agency.</StaggerItem>
      ...
      <section className="facebook-service__proof">
        <div className="container">
          ...
          <StaggerGroup className="facebook-service__videos">
            <StaggerItem as="article"><Image src="/images/unsplash/partner-david.jpg" alt="Agency partner David Cho discussing Yellow's headless web development support" fill sizes="(max-width: 760px) 100vw, 50vw" /><div><h3>David Cho</h3><p>CTO &amp; Co-Founder, Vector Digital</p></div></StaggerItem>
            <StaggerItem as="article"><Image src="/images/unsplash/partner-elena.jpg" alt="Agency partner Elena Rostova sharing an enterprise web development success story" fill sizes="(max-width: 760px) 100vw, 50vw" /><div><h3>Elena Rostova</h3><p>Managing Director, Nexus Tech</p></div></StaggerItem>
          </StaggerGroup>
        </div>
      </section>
      ...
      <section className="facebook-service__final-cta"><Reveal className="container"><div><p className="eyebrow">Your development team behind the scenes</p><ServiceHeading>Ready to add web development capacity?</ServiceHeading><p>Let’s map the right white-label engineering model for your agency and clients.</p></div><Link href="/book-appointment" className="button button--dark">Book a free strategy call <span aria-hidden="true">↗</span></Link></Reveal></section>
    </main>
  );
}
