...
export const caseStudies: CaseStudy[] = [
  ...
  { slug: "dental-digital-marketing-case-study", client: "Northstar Dental", industry: "Dental", title: "Dental digital marketing case study", summary: "A new local-growth system made treatment discovery and appointment requests easier to measure.", result: "Organic patient leads", metric: "+184%" },
  { slug: "hvac-digital-marketing-case-study", client: "Bright Air Co.", industry: "HVAC", title: "HVAC digital marketing case study", summary: "Service-area pages and high-intent search campaigns captured more urgent seasonal demand.", result: "Conversion rate", metric: "+216%" },
  { slug: "outdoor-blinds-digital-marketing-case-study", client: "Shade House", industry: "Outdoor Blinds", title: "Outdoor blinds digital marketing case study", summary: "Visual campaign creative and a simpler quotation journey increased high-value homeowner inquiries.", result: "Quote requests", metric: "+89%" },
  { slug: "cold-email-outreach-digital-marketing-case-study", client: "Axis B2B", industry: "B2B Outreach", title: "Cold email outreach case study", summary: "Sharper targeting and a focused message system turned outbound activity into qualified conversations.", result: "Positive replies", metric: "+132%" },
  { slug: "auto-dealer-google-ads-case-study", client: "Metro Motors", industry: "Google Ads", title: "Auto dealer Google Ads case study", summary: "Account restructuring connected high-intent searches with relevant inventory and clearer actions.", result: "Cost per lead", metric: "-47%" },
  { slug: "party-rentals-google-ads-case-study", client: "Gather & Glow", industry: "Party Rentals", title: "Party rentals Google Ads case study", summary: "Seasonal search campaigns helped a local rental team reach customers planning their next event.", result: "Booked events", metric: "+103%" },
];
