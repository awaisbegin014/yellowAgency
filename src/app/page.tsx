...
export default function Home() {
  return (
    <main id="top" className="reference-home">
      ...
      <section className="hc-section hc-support"><div className="hc-shell hc-centered"><h2>How Will Our Support Team<br />Help You?</h2><p>Every client project is supervised by a client success manager and project manager, with clear KPIs, reports, analysis, and updates ready for your clients.</p><Link href="/dedicated-teams" className="hc-btn hc-btn--outline">Learn More</Link><div className="hc-support-flow" aria-label="Support delivery flow"><svg className="hc-support-connectors" viewBox="0 0 1600 650" preserveAspectRatio="none" aria-hidden="true"><defs><marker id="support-arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse"><path d="M 0 0 L 10 5 L 0 10 z" /></marker></defs><path d="M180 205 L220 250" /><path d="M380 330 L420 390" /><path d="M590 445 L610 438" /><path d="M790 390 L810 350" /><path d="M990 270 L1010 210" /><path d="M1190 210 L1210 270" /><path d="M1390 270 L1410 210" /></svg>{supportFlow.map(({ role, icon, tone }) => <div className={`hc-support-step hc-support-step--${tone}`} key={role}><div className="hc-support-node"><span aria-hidden="true">{icon}</span><strong>{role}</strong></div></div>)}</div></div></section>
